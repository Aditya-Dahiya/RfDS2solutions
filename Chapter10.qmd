...
The default geom associated with `stat_summary()` is `geom_pointrange()` . It belongs to a class of functions displaying vertical intervals with lines, crossbars and error-bars. The functions are:
